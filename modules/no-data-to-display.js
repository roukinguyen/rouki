...
(function(d) {
    ...
    (function(c) {
        ...
        k("bubble gauge heatmap pie treemap waterfall".split(" "), function(a) {
            g[a] &&
        ...
        e.showNoData = function(a) {
            ...
            a = a || b.lang.noData;
            b = b.noData;
            this.noDataLabel || (this.noDataLabel = this.renderer.label(a, 0, 0, null, null, null, b.useHTML, null, "no-data"), this.noDataLabel.attr(b.attr).css(b.style), this.noDataLabel.add(), this.noDataLabel.align(h(this.noDataLabel.getBBox(), b.position), !1, "plotBox"))
        };
        e.hideNoData =
            function() {
